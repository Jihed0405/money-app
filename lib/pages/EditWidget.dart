  ...
  void submitExpense(DataStateNotifier dataStateNotifier, WidgetRef ref) {
    ...
    switch (ref.watch(isExpenses)) {
      case true:
        ...
        ref.read(itemCategory.notifier).state =
                    ...
                    child: ToggleButtons(
                      onPressed: (int index) {
                        for (int buttonIndex = 0;
                            ...
                            buttonIndex++) {
                          ref
                              .read(isSelectedExpenses.notifier)
                              .state[buttonIndex] = buttonIndex == index;
                          if (index == 1) {
                          ...
                          child: TextField(
                            ...
                            onSubmitted: (String value) async {
                              ref.read(canSubmit.notifier).state =
                                  ref.watch(dateController).text.isNotEmpty &&
                                      value.isNotEmpty;
                            },
                          ),
                        ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.all(defaultSpacing / 30),
                                child: DropdownButtonFormField<String>(
                                  ...
                                  onChanged: (String? recurrenceValue) {
                                    ...
                                    ref
                                        .read(dropdownValueRecurrence.notifier)
                                        .state = recurrenceValue!;
                                  },
                                ...
                                child: DropdownButtonFormField<String>(
                                    ...
                                    onChanged: (String? value) {
                                      ...
                                      if (ref.watch(isExpenses)) {
                                        ref
                                            .read(
                                                dropdownValueExpenses.notifier)
                                            .state = value!;
                                      } else {
                                        ref
                                            .read(dropdownValueIncome.notifier)
                                            .state = value!;
                                      }
                                    },
