                  ...
                  color: Colors.transparent,
                    child: ListTile(
                      title: Container(
                        ...
                        child: Center(
                          child: Text(_listFilter[index],style:  Theme.of(context)
                            .textTheme
                            .bodyMedium
                            ?.copyWith(fontWeight: FontWeight.w500,color: _selectedIndex != null && _selectedIndex == index
                          ? Colors.blue[300]
                          : fontSubHeading, fontSize: fontSizeBody),),
                        ),
                      ),
                  ...
                  color: Colors.transparent,
                    child: ListTile(
                      ...
                      padding: EdgeInsets.only(left: 10),
                        ...
                        child: Center(
                          child: Text(_listCategory[index],style:  Theme.of(context)
                            .textTheme
                            .bodyMedium
                            ?.copyWith(fontWeight: FontWeight.w500,color: _selectedCategoryIndex != null && _selectedIndex == index
                          ? Colors.blue[300]
                          : fontSubHeading, fontSize: fontSizeBody),),
                        ),
                      ),
